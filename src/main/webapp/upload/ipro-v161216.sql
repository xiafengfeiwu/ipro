...
-- Records of w_pump
-- ----------------------------
INSERT INTO `w_pump` VALUES ('1', 'pname1', '1', '2', 'CN101010100', null, null, null, '2016-12-15 13:56:52', '2016-12-15 13:56:54');
...
-- Records of w_role
-- ----------------------------
INSERT INTO `w_role` VALUES ('809009869884489728', '运维', '0', '2016-12-14 20:19:51', '2016-12-14 20:19:54');
INSERT INTO `w_role` VALUES ('809010263649943552', '农户', '0', '2016-12-14 20:21:09', '2016-12-14 20:21:11');
INSERT INTO `w_role` VALUES ('809010376153759744', '政府机构', '0', '2016-12-14 20:18:50', '2016-12-14 20:18:52');
INSERT INTO `w_role` VALUES ('809010432411959296', '设备厂家', '0', '2016-12-14 20:19:28', '2016-12-14 20:19:30');
INSERT INTO `w_role` VALUES ('809010544915775488', '供电局', '0', '2016-12-14 20:20:47', '2016-12-14 20:20:49');
INSERT INTO `w_role` VALUES ('809010994926845952', '业务专家', '0', '2016-12-14 20:20:14', '2016-12-14 20:20:17');
...
INSERT INTO `w_role_menu` VALUES ('809601566439899136', '808491424977780736', '808491031212326912');
...
-- Records of w_user
-- ----------------------------
INSERT INTO `w_user` VALUES ('1', 'sizhongxia', '司仲夏', 'sizhongxia', '18518436862', '7c4a8d09ca3762af61e59520943dc26494f8941b', '809010263649943552', 'resources/img/default_head_124x124.png', null, '0', '2016-12-14 20:24:13', '2016-12-14 20:24:15');
INSERT INTO `w_user` VALUES ('2', 'admin', '系统管理员', 'xitongguanliyuan', '15503832989', '7c4a8d09ca3762af61e59520943dc26494f8941b', '809601566439899136', 'resources/img/default_head_124x124.png', '', '0', '2016-12-14 20:24:13', '2016-12-14 20:24:15');
...
CREATE TABLE `w_weather_alarm` (
  ...
  `early_warn_time` date DEFAULT NULL COMMENT '发布时间',
  `early_warn_level` varchar(6) DEFAULT NULL COMMENT '预警级别',
  `early_warn_stat` varchar(255) DEFAULT NULL COMMENT '预警状态',
  `early_warn_type` varchar(255) DEFAULT NULL COMMENT '预警类别',
  `early_warn_title` varchar(80) DEFAULT NULL COMMENT '预警标题',
  `early_warn_txt` varchar(500) DEFAULT NULL COMMENT '预警说明',
...
CREATE TABLE `w_weather_data` (
  ...
  `cond_txt` varchar(10) DEFAULT NULL COMMENT '天气状况描述',
  `fl` varchar(10) DEFAULT NULL COMMENT '体感温度',
  `hum` varchar(10) DEFAULT NULL COMMENT '相对湿度（%）',
  `pcpn` char(3) DEFAULT NULL COMMENT '降水量（mm）',
  `pres` char(3) DEFAULT NULL COMMENT '气压',
  `tmp` varchar(255) DEFAULT NULL COMMENT '温度',
  `vis` varchar(255) DEFAULT NULL COMMENT '能见度（km）',
  `wind_deg` varchar(255) DEFAULT NULL COMMENT '风向（360度）',
  `wind_dir` varchar(255) DEFAULT NULL COMMENT '风向',
  `wind_sc` varchar(255) DEFAULT NULL COMMENT '风力',
  `wind_spd` varchar(255) DEFAULT NULL COMMENT '风速（kmph）',
...
-- ----------------------------
INSERT INTO `w_weather_key` VALUES ('809645772998967297', '61f8b49409404b679018a177fe840efc', 'weah_1@outlook.com', 'weather123');
