        ...
        <c:if test='${!"success".equals(status) }'>
	        <div class="row">
	            <div class="col-sm-8 col-sm-offset-2">
	                <form method="post" action="user/resetUserStatusAction.jspx" class="form-horizontal">
	                	<input type="hidden" name="userId" class="form-control" value="${userId }">
	                    <div class="form-group text-center">确认要 ${statusText } 用户 ${userName } (${userPhone }) 账号吗？</div>
				        <div class="form-group">
	                        <div class="col-sm-12 text-center">
	                        	<button class="btn btn-primary" type="submit">确认${statusText }</button>
	                        </div>
	                    </div>
	                </form>
	            </div>
