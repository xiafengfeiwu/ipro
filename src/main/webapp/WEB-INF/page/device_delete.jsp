...
<body class="gray-bg">
	 <div class="wrapper wrapper-content animated fadeIn">
        ...
        <c:if test="${!\"success\".equals(status) }">
	        <div class="row">
	            <div class="col-sm-8 col-sm-offset-2">
	                <form method="post" action="device/deleteAction.jspx" class="form-horizontal">
	                	<input type="hidden" name="deviceId" class="form-control" value="${device.deviceId }">
	                    <div class="form-group text-center">确认要删除设备  ${device.deviceName } （${device.deviceSn }） 吗？</div>
        ...
        <c:if test="${\"success\".equals(status)}">
        	<div class="row">
           		<div class="col-sm-8 col-sm-offset-2">
        			<div class="form-group text-center">设备已被删除。</div>
        		</div>
        	</div>
