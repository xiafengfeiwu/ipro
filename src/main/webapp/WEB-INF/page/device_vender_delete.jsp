...
<body class="gray-bg">
	 <div class="wrapper wrapper-content animated fadeIn">
        ...
        <c:if test='${!"success".equals(status) }'>
	        <div class="row">
	            <div class="col-sm-8 col-sm-offset-2">
	                <form method="post" action="device/deleteVenderAction.jspx" class="form-horizontal">
	                	<input type="hidden" name="venderId" class="form-control" value="${vender.venderId }">
	                    <div class="form-group text-center">确认要删除设备供应商 ${vender.venderName } （${vender.venderCode }） 吗？</div>
        ...
        <c:if test='${"success".equals(status)}'>
        	<div class="row">
           		<div class="col-sm-8 col-sm-offset-2">
        			<div class="form-group text-center">供应商已被删除。</div>
        		</div>
        	</div>
