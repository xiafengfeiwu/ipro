	 ...
	 <div class="wrapper wrapper-content animated fadeIn">
        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <form method="post" action="user/changeSelfAction.jspx" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="userLoginName" class="form-control" value="${user.userLoginName }">
                        </div>
                    </div>
                    <div class="form-group">
