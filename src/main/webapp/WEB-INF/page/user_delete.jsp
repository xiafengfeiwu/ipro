...
<body class="gray-bg">
	 <div class="wrapper wrapper-content animated fadeIn">
        ...
        <c:if test="${!\"success\".equals(status) }">
	        <div class="row">
	            <div class="col-sm-8 col-sm-offset-2">
	                <form method="post" action="user/deleteAction.jspx" class="form-horizontal">
	                	<input type="hidden" name="userId" class="form-control" value="${userId }">
	                    <div class="form-group text-center">确认要删除用户 ${userName } (${userPhone }) 吗？</div>
        ...
        <c:if test="${\"success\".equals(status)}">
        	<div class="row">
           		<div class="col-sm-8 col-sm-offset-2">
        			<div class="form-group text-center">用户已被删除。</div>
        		</div>
        	</div>
