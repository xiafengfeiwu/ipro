                	...
                	<div class="row">
	                    <div class="form-group col-xs-6">
	                        ...
	                        <div class="col-sm-10">
	                            ...
	                            <span class="help-block m-b-none pull-right">未找到？<a href="device/createVender.jspx">创建</a>一个新的供应商</span>
	                        </div>
	                    </div>
	                    <div class="form-group col-xs-6">
	                        ...
	                        <div class="col-sm-10">
	                            <select class="form-control" name="deviceType">
	                            	...
	                            	<option value="AL-CJ">AL-采集器</option>
	                            	<option value="AL-D-CJ">AL-单点采集器</option>
	                            	<option value="AL-JZ">AL-集中器</option>
	                            </select>
	                    ...
	                    <div class="form-group col-xs-6">
	                        ...
	                        <div class="col-sm-10">
	                            <input type="text" name="deviceSn" class="form-control" value="">
	                        </div>
	                    </div>
	                    <div class="form-group col-xs-6">
