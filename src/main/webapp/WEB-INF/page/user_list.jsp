...
<link href="resources/js/plugins/padding/paging.css" rel="stylesheet">
...
<body class="gray-bg">
					...
					<div class="ibox-content">
						...
						<div class="table-responsive">
							<table class="table table-striped">
								...
								<tfoot>
									<tr>
										<td colspan="7"><div id="pageTool"></div></td>
									</tr>
								</tfoot>
							</table>
						</div>
	...
	<script src="resources/js/plugins/padding/query.js"></script>
	<script src="resources/js/plugins/padding/paging.js"></script>
